...
from models import EfficientNetB0, cnn, DenseNet201, GoogLeNet
...
if __name__ == '__main__':
    ...
    net = GoogLeNet()
    checkpoint = torch.load('/home/group3/submission/code/checkpoint/googlenet.pth')
    net.load_state_dict(checkpoint['net'])
    ensemble_model['googLe' \
                   '' \
                   ''] = net
    print('Load denseNet with acc =', checkpoint['acc'])
    net = net.to(device)
